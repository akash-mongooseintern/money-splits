...
-- CreateTable
CREATE TABLE "transaction_user_relation" (
...
-- CreateIndex
CREATE UNIQUE INDEX "setting_option_value_setting_id_key" ON "setting_option"("value", "setting_id");

-- CreateIndex
CREATE UNIQUE INDEX "transaction_user_relation_transaction_id_user_id_key" ON "transaction_user_relation"("transaction_id", "user_id");
...
-- AddForeignKey
ALTER TABLE "transaction_user_relation" ADD CONSTRAINT "transaction_user_relation_transaction_id_fkey" FOREIGN KEY ("transaction_id") REFERENCES "transactions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "transaction_user_relation" ADD CONSTRAINT "transaction_user_relation_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
